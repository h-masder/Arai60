...
- なんだかうまく解けないなと思いdiscordをみていたところ、以下のコメントをみつけた。
- 
- 納得したのでこんな感じでやってみようと思う。
...
- あとはどうやってnumsのアクセスするかを決める。2を含むものすべてを調べる、3を含むものすべてを調べる、,,,と進めていけばよい。
...
- どういう状況だとこれを選ぶことになるのだろう。
  ...
  - 計算量O(NlogN)くらいかかるので、上の改良パターンのほうが計算量は小さい。
